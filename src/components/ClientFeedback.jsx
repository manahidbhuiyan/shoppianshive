                ...
                <div className="flex justify-between flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-7/12 xl:w-8/12 px-3">
                        <div className="card-items pb-[45px] border-b border-[#D5C5EF] ">
                            ...
                            <p className="text-[26px] font-normal leading-[46px] text-[#3F444B] mb-9 ">It’s a pleasure working with Bunker. They understood our new brand positioning guidelines and translated them beautifully and consistently into.</p>
                        ...
                        <div className="flex justify-between items-center mt-[35px] gap-[35px] ">
                                    <div>
