...
const BreadCrumb = ({current}) => {
  return (
    <div className='bg-cover bg-no-repeat bg-center w-full relative ' style={{ backgroundImage: `url(${bgImage})` }}>
      <div className="absolute inset-0 w-full h-full bg-gradient-to-t from-[#0F175B]/[0.94] to-[#1E2FC0]/[0.94] "></div>
      <div className="container mx-auto">
        <div className="relative py-[100px] z-10 animate-bottom-top" >
            ...
            <div className='inline-flex justify-center gap-2.5 py-2.5 px-[30px] bg-white rounded-4xl mt-5 text-base font-medium '>
                <p className='text-[#161616] hover:text-[#3147ff] cursor-pointer '>Home</p>
